...
insert into users (id, firstname, lastname, email, category, image, password) values (1, 'Maris', 'Dwerryhouse', 'mateo.d8@hotmail.com', 'admin', 'password', 'http://dummyimage.com/100x100.png/5fa2dd/ffffff');
insert into users (id, firstname, lastname, email, category, image, password) values (2, 'Luis', 'Chesswas', 'lchesswas1@seesaa.net', 'client', 'password','http://dummyimage.com/100x100.png/ff4444/ffffff');
insert into users (id, firstname, lastname, email, category, image, password) values (3, 'Denis', 'Cattonnet', 'dcattonnet2@time.com', 'client', 'password','http://dummyimage.com/100x100.png/ff4444/ffffff');
insert into users (id, firstname, lastname, email, category, image, password) values (4, 'Silvana', 'Jewitt', 'sjewitt3@abc.net.au', 'client', 'password','http://dummyimage.com/100x100.png/ff4444/ffffff');
